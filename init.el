...
;; Declare elpaca-repos to avoid the warning
(defvar elpaca-repos nil
  "List of repositories for Elpaca to use.")

;; Assign repositories to elpaca-repos
(setq elpaca-repos '(("melpa-stable" . "https://stable.melpa.org/packages/")
